...
/** Mobile wishlist action bar — aligned with MyPageMobileHeader. */
export function WishlistMobileHeader() {
  return (
    <header className="sticky top-0 z-50 flex h-[52px] shrink-0 items-center gap-1.5 bg-white px-3 lg:hidden">
      ...
      <h1 className="m-0 min-w-0 flex-1 truncate pl-1.5 text-titleMedium text-black">찜한 상품</h1>
