...
/** Figma 70:3882 — MO order complete action bar (back + title + home). */
export function OrderCompleteMobileHeader() {
  return (
    <header className="sticky top-0 z-50 flex h-[52px] shrink-0 items-center gap-1 bg-white px-3 lg:hidden">
      ...
      <h1 className="m-0 min-w-0 flex-1 truncate pl-1.5 text-titleMedium text-black">주문완료</h1>
      <button
        type="button"
