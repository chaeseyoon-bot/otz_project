...
export interface CheckoutPaymentSummaryCardProps {
  title?: string
...
/** Figma 57:4124 (default) / 56:6467 (expanded sub-rows) — payment amount summary card. */
export function CheckoutPaymentSummaryCard({
  title = '결제금액',
  productAmountOpen,
  ...
  earnPoints,
  reviewPointsLabel,
}: CheckoutPaymentSummaryCardProps) {
  return (
    <div className="w-full rounded-lg border border-lightGray bg-white pt-4 pb-6">
      <div className="flex flex-col gap-6 px-4">
        <div className="border-b border-lightGray pb-4">
          <h2 className="m-0 text-bodyBold2 text-dark">{title}</h2>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-6 border-t border-lightGray pt-6">
            <div className="flex items-center justify-between">
              <span className="text-bodyBold2 text-dark">최종 결제 금액</span>
