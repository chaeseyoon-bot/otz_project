...
const HERO_UNIQUE: HeroSlide[] = [
  {
    ...
    ctaLabel: '쇼핑 바로가기',
    imageUrl: mainImageAsset('banner_01.png'),
  },
  {
    id: 'hero-b',
    title: ':DOT EDITION',
    ...
    ctaLabel: '쇼핑 바로가기',
    imageUrl: mainImageAsset('banner_02.png'),
  },
  {
    id: 'hero-c',
    ...
    ctaLabel: '쇼핑 바로가기',
    imageUrl: mainImageAsset('banner_03.png'),
  },
  {
    id: 'hero-d',
    title: 'OTZ x LOFA Seoul',
...
export const planningBanner: PromotionalBanner = {
  ...
  imageUrl: mainImageAsset('promo_03.png'),
}

export const curationItems: CurationItem[] = [
  {
    id: 'curation-1',
    imageUrl: mainImageAsset('curation_01.png'),
  ...
  {
    id: 'curation-2',
    imageUrl: mainImageAsset('curation_02.png'),
  ...
  {
    id: 'curation-3',
    imageUrl: mainImageAsset('curation_03.png'),
  ...
  {
    id: 'curation-4',
    imageUrl: mainImageAsset('curation_04.png'),
